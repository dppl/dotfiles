# Generated by Powerlevel10k configuration wizard on 2019-09-19 at 10:17 CEST.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 57737.
...
() {
  ...
  local vcs=''
  # If on a branch...
  vcs+='${${VCS_STATUS_LOCAL_BRANCH:+%4F'${(g::)POWERLEVEL9K_VCS_BRANCH_ICON}
  ...
  vcs+=':-${VCS_STATUS_LOCAL_BRANCH[1,12]//\%/%%}%28F…%4F${VCS_STATUS_LOCAL_BRANCH[-12,-1]//\%/%%}}}'
  ...
  vcs+='${${VCS_STATUS_NUM_UNTRACKED:#0}:+ %6F'${(g::)POWERLEVEL9K_VCS_UNTRACKED_ICON}'${VCS_STATUS_NUM_UNTRACKED}}'
  ...
  #################[ ranger: ranger shell (https://github.com/ranger/ranger) ]##################
  # Ranger shell color.
  typeset -g POWERLEVEL9K_RANGER_FOREGROUND=4
  # Custom icon.
  ...
  ################[ terraform: terraform workspace (https://www.terraform.io) ]#################
  # Terraform color.
  typeset -g POWERLEVEL9K_TERRAFORM_FOREGROUND=6
  # Custom icon.
  ...
  #########################[ proxy: system-wide http/https/ftp proxy ]##########################
  # Proxy color.
  typeset -g POWERLEVEL9K_PROXY_FOREGROUND=6
  # Custom icon.
